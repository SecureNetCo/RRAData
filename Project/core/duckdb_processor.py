...
class DuckDBProcessor:
    ...
    def __init__(
        ...
        if not SCHEMA_CACHE_BY_URL:
            SCHEMA_CACHE_BY_URL.update({
            # DataA URLs (12개 파일)
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/1_safetykorea_flattened.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/3_efficiency_flattened.parquet": ["crawl_date", "신청번호", "업체명", "모델명", "월간소비전력량", "용량", "효율등급", "구효율등급", "완료일", "detail_url", "product_id", "category_code", "category_name", "에너지소비효율등급정보", "에너지소비효율등급제품상세정보", "제품이미지"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/4_high_efficiency_flattened.parquet": ["crawl_date", "인증번호", "모델명", "업체명", "시험기관명", "용량", "효율", "형식", "인증일자", "인증만료일자", "이메일", "업체주소", "category_name", "제품이미지", "대표전화", "대표FAX"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/5_standby_power_flattened.parquet": ["crawl_date", "번호", "업체명", "완료일자", "모델명", "시험기관", "제조원", "국산/수입", "대기전력저감기준만족여부", "인쇄방식", "흑백/칼라구분", "제품속도흑백(ipm)", "주간소비전력량(기준치 kWh)/td>", "주간소비전력량(측정치 kWh)", "슬립모드소비전력(W)", "슬립모드이행시간(분)", "오프모드소비전력(W)", "네트워크지원기능", "양면인쇄가능여부", "제품속도칼라(ipm)", "정격소비전력(W)", "RAM(MB)", "해상도(DPI)", "온모드소비전력(W)", "category_number", "제품이미지", "주간소비전력량(기준치 kWh)", "프린트기능제공여부", "복사기구분", "팩시밀리기능제공여부", "주간소비전력량(기준치kWh)", "주간소비전력량(측정치kWh)", "기타특징", "오프모드유무", "광학해상도(dpi)", "최대해상도(dpi)", "비트깊이(Grayscale/Color)", "스캐너분류", "칼라", "호환성", "대기전력저감기준 만족여부", "제품명(제품형태)", "대기전력자동차단스위치(컨트롤러) >> 최대 제어가능 콘센트 또는 멀티탭 개수<", "유무선통신인터페이스유무", "대기전력차단시소비전력(W)", "복대기전력차단기능이행시간(초)", "에너지절약마크또는대기전력경고표지표시위치", "작동원리", "안전인증,기타인증사항", "온상태변환", "절전제어장치제한내용<", "에너지절약마크 또는 대기전력경고표지 표시위치", "오디오분류", "리모컨유무", "대기모드소비전력(W)", "라디오분류", "전자레인지분류", "무선인터페이스", "전자레인지기능", "도어폰분류", "복합기능(복합기능 도어폰의 경우)", "분류", "고정장치대기모드소비전력(W)", "충전장치대기모드소비전력(W)", "자동누전차단기유무", "전열대기모드소비전력(W)", "구분", "추가장치(복수선택가능)", "랜포트수(해당 추가장치 선택시 입력)", "감지방식", "전원스위치유무", "슬립모드이행시간(초)", "컴퓨터유형"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/6_approval_flattened.parquet": ["product_id", "sub_id", "crawled_at", "site_type", "승인번호", "승인일자", "구분(제조/수입)", "업체명", "제품명", "품목", "제품제형", "저장방법 및 유통기한", "중량·용량·매수", "용법·용량", "사용상의 주의사항"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/7_declare_flattened.parquet": ["product_id", "신고번호", "시험검사기관", "제품구분(대표/파생)", "신고증명서 발급일", "성적발급구분", "검사기준", "시험성적서 만료일", "구분(제조/수입)", "업체", "제품명", "분류", "품목.용도", "어린이보호포장 대상", "제품제형", "유통기한", "중량·용량·매수·크기", "어는점", "액성", "표준사용량", "제조자,  주소, 연락처", "사용방법", "사용상 주의사항", "응급처치", "표시도안", "판매자, 주소, 연락처", "수입자,  주소, 연락처", "제조국명, 제조회사"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/8_kwtc_flattened.parquet": ["no", "crtfcId", "rceptNo", "reqstId", "crtfcDe", "crtfcVer", "othbcAt", "ovseaAdresAt", "entrprsNm", "prductNm", "frstCrtfcDe", "modelCnt", "totalCnt", "crtfcDeEnd", "prpos", "jdgmnSe", "crtfcSttus", "rprsntvNm", "fctryTelno", "addres", "fctryAdres", "model_cmpntNm", "model_hsCode", "model_g2bCode", "model_name", "model_kndGrad", "model_mtrqlt", "crawled_at"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/9_recall_flattened.parquet": ["recallUid", "조치구분", "품목명", "브랜드명", "사업자명", "대표자명", "모델명", "제조구분(제조국)", "인증/신고번호", "인증/신고일자", "제품결함", "위해정보", "소비자 행동요령", "문의처", "연락처", "안전관리대상구분", "전체사진", "부분사진", "productNumber"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/10_safetykoreachild_flattened.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/11_rra_cert_flattened.parquet": ["cert_no", "business_name", "material_name", "basic_model", "derived_models", "manufacturer", "country", "cert_date", "etc_matter", "crawled_at"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/12_rra_self_cert_flattened.parquet": ["cert_no", "business_name", "material_name", "basic_model", "derived_models", "manufacturer", "country", "cert_date", "etc_matter", "error"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/13_safetykoreahome_flattened.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications"],

            # DataB URL (1개 파일)
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/2_wadiz_flattened.parquet": ["category", "상호/법인명", "주요 제품", "업종", "기업규모", "기업유형", "종업원수", "대표자 정보", "설립일", "주소", "홈페이지", "전화번호", "벤처기업인증", "지적재산권", "사업자등록번호", "corp_no"],

            # DataC Success URLs (13개 파일) - enhanced/success
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/1_safetykorea_flattened_success.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/2_wadiz_flattened_success.parquet": ["category", "상호/법인명", "주요 제품", "업종", "기업규모", "기업유형", "종업원수", "대표자 정보", "설립일", "주소", "홈페이지", "전화번호", "벤처기업인증", "지적재산권", "사업자등록번호", "corp_no", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/3_efficiency_flattened_success.parquet": ["crawl_date", "신청번호", "업체명", "모델명", "월간소비전력량", "용량", "효율등급", "구효율등급", "완료일", "detail_url", "product_id", "category_code", "category_name", "에너지소비효율등급정보", "에너지소비효율등급제품상세정보", "제품이미지", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/4_high_efficiency_flattened_success.parquet": ["crawl_date", "인증번호", "모델명", "업체명", "시험기관명", "용량", "효율", "형식", "인증일자", "인증만료일자", "이메일", "업체주소", "category_name", "제품이미지", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type", "대표전화", "대표FAX"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/5_standby_power_flattened_success.parquet": ["crawl_date", "번호", "업체명", "완료일자", "모델명", "시험기관", "제조원", "국산/수입", "대기전력저감기준만족여부", "인쇄방식", "흑백/칼라구분", "제품속도흑백(ipm)", "주간소비전력량(기준치 kWh)/td>", "주간소비전력량(측정치 kWh)", "슬립모드소비전력(W)", "슬립모드이행시간(분)", "오프모드소비전력(W)", "네트워크지원기능", "양면인쇄가능여부", "제품속도칼라(ipm)", "정격소비전력(W)", "RAM(MB)", "해상도(DPI)", "온모드소비전력(W)", "category_number", "제품이미지", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type", "주간소비전력량(기준치 kWh)", "프린트기능제공여부", "복사기구분", "팩시밀리기능제공여부", "주간소비전력량(기준치kWh)", "주간소비전력량(측정치kWh)", "오프모드유무", "광학해상도(dpi)", "최대해상도(dpi)", "비트깊이(Grayscale/Color)", "스캐너분류", "칼라", "호환성", "기타특징", "대기전력저감기준 만족여부", "제품명(제품형태)", "대기전력자동차단스위치(컨트롤러) >> 최대 제어가능 콘센트 또는 멀티탭 개수<", "유무선통신인터페이스유무", "대기전력차단시소비전력(W)", "복대기전력차단기능이행시간(초)", "에너지절약마크또는대기전력경고표지표시위치", "작동원리", "안전인증,기타인증사항", "온상태변환", "절전제어장치제한내용<", "오디오분류", "리모컨유무", "대기모드소비전력(W)", "에너지절약마크 또는 대기전력경고표지 표시위치", "라디오분류", "전자레인지분류", "무선인터페이스", "전자레인지기능", "도어폰분류", "복합기능(복합기능 도어폰의 경우)", "분류", "고정장치대기모드소비전력(W)", "충전장치대기모드소비전력(W)", "자동누전차단기유무", "전열대기모드소비전력(W)", "구분", "추가장치(복수선택가능)", "랜포트수(해당 추가장치 선택시 입력)", "감지방식", "전원스위치유무", "슬립모드이행시간(초)", "컴퓨터유형"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/6_approval_flattened_success.parquet": ["product_id", "sub_id", "crawled_at", "site_type", "승인번호", "승인일자", "구분(제조/수입)", "업체명", "제품명", "품목", "제품제형", "저장방법 및 유통기한", "중량·용량·매수", "용법·용량", "사용상의 주의사항", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/7_declare_flattened_success.parquet": ["product_id", "신고번호", "시험검사기관", "제품구분(대표/파생)", "신고증명서 발급일", "성적발급구분", "검사기준", "시험성적서 만료일", "구분(제조/수입)", "업체", "제품명", "분류", "품목.용도", "어린이보호포장 대상", "제품제형", "유통기한", "중량·용량·매수·크기", "어는점", "액성", "표준사용량", "판매자, 주소, 연락처", "제조자,  주소, 연락처", "사용방법", "사용상 주의사항", "응급처치", "표시도안", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type", "수입자,  주소, 연락처", "제조국명, 제조회사"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/8_kwtc_flattened_success.parquet": ["no", "crtfcId", "rceptNo", "reqstId", "crtfcDe", "crtfcVer", "othbcAt", "ovseaAdresAt", "entrprsNm", "prductNm", "frstCrtfcDe", "modelCnt", "totalCnt", "crtfcDeEnd", "prpos", "jdgmnSe", "crtfcSttus", "rprsntvNm", "fctryTelno", "addres", "fctryAdres", "model_cmpntNm", "model_hsCode", "model_g2bCode", "model_name", "model_kndGrad", "model_mtrqlt", "crawled_at", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/9_recall_flattened_success.parquet": ["recallUid", "조치구분", "품목명", "브랜드명", "사업자명", "대표자명", "모델명", "제조구분(제조국)", "인증/신고번호", "인증/신고일자", "제품결함", "위해정보", "소비자 행동요령", "문의처", "연락처", "안전관리대상구분", "전체사진", "부분사진", "productNumber", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/10_safetykoreachild_flattened_success.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/11_rra_cert_flattened_success.parquet": ["cert_no", "business_name", "material_name", "basic_model", "derived_models", "manufacturer", "country", "cert_date", "etc_matter", "crawled_at", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/12_rra_self_cert_flattened_success.parquet": ["cert_no", "business_name", "material_name", "basic_model", "derived_models", "manufacturer", "country", "cert_date", "etc_matter", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/success/13_safetykoreahome_flattened_success.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],

            # DataC Failed URLs (13개 파일) - enhanced/failed
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/1_safetykorea_flattened_failed.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/2_wadiz_flattened_failed.parquet": ["category", "상호/법인명", "주요 제품", "업종", "기업규모", "기업유형", "종업원수", "대표자 정보", "설립일", "주소", "홈페이지", "전화번호", "벤처기업인증", "지적재산권", "사업자등록번호", "corp_no", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/3_efficiency_flattened_failed.parquet": ["crawl_date", "신청번호", "업체명", "모델명", "월간소비전력량", "용량", "효율등급", "구효율등급", "완료일", "detail_url", "product_id", "category_code", "category_name", "에너지소비효율등급정보", "에너지소비효율등급제품상세정보", "제품이미지", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/4_high_efficiency_flattened_failed.parquet": ["crawl_date", "인증번호", "모델명", "업체명", "시험기관명", "용량", "효율", "형식", "인증일자", "인증만료일자", "업체주소", "category_name", "제품이미지", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type", "이메일", "대표전화", "대표FAX"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/5_standby_power_flattened_failed.parquet": ["crawl_date", "번호", "업체명", "완료일자", "모델명", "시험기관", "제조원", "국산/수입", "대기전력저감기준만족여부", "인쇄방식", "흑백/칼라구분", "제품속도흑백(ipm)", "주간소비전력량(기준치 kWh)/td>", "주간소비전력량(측정치 kWh)", "슬립모드소비전력(W)", "슬립모드이행시간(분)", "오프모드소비전력(W)", "네트워크지원기능", "양면인쇄가능여부", "제품속도칼라(ipm)", "정격소비전력(W)", "RAM(MB)", "해상도(DPI)", "온모드소비전력(W)", "category_number", "제품이미지", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type", "주간소비전력량(기준치 kWh)", "프린트기능제공여부", "복사기구분", "팩시밀리기능제공여부", "주간소비전력량(기준치kWh)", "주간소비전력량(측정치kWh)", "기타특징", "스캐너분류", "오프모드유무", "칼라", "광학해상도(dpi)", "최대해상도(dpi)", "비트깊이(Grayscale/Color)", "호환성", "대기전력저감기준 만족여부", "제품명(제품형태)", "대기전력자동차단스위치(컨트롤러) >> 최대 제어가능 콘센트 또는 멀티탭 개수<", "유무선통신인터페이스유무", "대기전력차단시소비전력(W)", "복대기전력차단기능이행시간(초)", "작동원리", "온상태변환", "에너지절약마크또는대기전력경고표지표시위치", "안전인증,기타인증사항", "절전제어장치제한내용<", "에너지절약마크 또는 대기전력경고표지 표시위치", "오디오분류", "리모컨유무", "대기모드소비전력(W)", "라디오분류", "전자레인지분류", "전자레인지기능", "무선인터페이스", "도어폰분류", "복합기능(복합기능 도어폰의 경우)", "분류", "고정장치대기모드소비전력(W)", "충전장치대기모드소비전력(W)", "자동누전차단기유무", "전열대기모드소비전력(W)", "추가장치(복수선택가능)", "랜포트수(해당 추가장치 선택시 입력)", "감지방식", "전원스위치유무", "슬립모드이행시간(초)", "컴퓨터유형"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/6_approval_flattened_failed.parquet": ["product_id", "sub_id", "crawled_at", "site_type", "승인번호", "승인일자", "구분(제조/수입)", "업체명", "제품명", "품목", "제품제형", "저장방법 및 유통기한", "중량·용량·매수", "용법·용량", "사용상의 주의사항", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/7_declare_flattened_failed.parquet": ["product_id", "신고번호", "시험검사기관", "제품구분(대표/파생)", "신고증명서 발급일", "성적발급구분", "검사기준", "시험성적서 만료일", "구분(제조/수입)", "업체", "제품명", "분류", "품목.용도", "어린이보호포장 대상", "제품제형", "유통기한", "중량·용량·매수·크기", "어는점", "액성", "표준사용량", "제조자,  주소, 연락처", "사용방법", "사용상 주의사항", "응급처치", "표시도안", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type", "판매자, 주소, 연락처", "수입자,  주소, 연락처", "제조국명, 제조회사"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/8_kwtc_flattened_failed.parquet": ["no", "crtfcId", "rceptNo", "reqstId", "crtfcDe", "crtfcVer", "othbcAt", "ovseaAdresAt", "entrprsNm", "prductNm", "frstCrtfcDe", "modelCnt", "totalCnt", "crtfcDeEnd", "prpos", "jdgmnSe", "crtfcSttus", "rprsntvNm", "fctryTelno", "addres", "fctryAdres", "model_cmpntNm", "model_hsCode", "model_g2bCode", "model_name", "model_kndGrad", "model_mtrqlt", "crawled_at", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/9_recall_flattened_failed.parquet": ["recallUid", "조치구분", "품목명", "브랜드명", "사업자명", "대표자명", "모델명", "제조구분(제조국)", "인증/신고번호", "인증/신고일자", "제품결함", "위해정보", "소비자 행동요령", "문의처", "연락처", "안전관리대상구분", "전체사진", "부분사진", "productNumber", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/10_safetykoreachild_flattened_failed.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/11_rra_cert_flattened_failed.parquet": ["cert_no", "business_name", "material_name", "basic_model", "derived_models", "manufacturer", "country", "cert_date", "etc_matter", "crawled_at", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/12_rra_self_cert_flattened_failed.parquet": ["cert_no", "business_name", "material_name", "basic_model", "derived_models", "manufacturer", "country", "cert_date", "etc_matter", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type", "error"],
            "https://pub-4e8cc58b92d64abea92f66878f367f88.r2.dev/datapage-parquet/enhanced/failed/13_safetykoreahome_flattened_failed.parquet": ["cert_uid", "cert_organ_name", "cert_num", "cert_state", "cert_div", "cert_date", "cert_chg_date", "cert_chg_reason", "first_cert_num", "product_name", "brand_name", "model_name", "category_name", "import_div", "maker_name", "maker_country_name", "importer_name", "remark", "sign_date", "derivation_models", "certification_image_urls", "factories", "similar_certifications", "ftc_sale_number", "ftc_company_name", "ftc_business_number", "ftc_representative", "ftc_phone", "ftc_email", "ftc_address", "ftc_road_address", "ftc_website", "ftc_registration_date", "ftc_business_status", "ftc_agency_name", "ftc_products", "ftc_sales_method", "ftc_corporation_type"],
        })

            for cache_key, columns in SCHEMA_CACHE_BY_URL.items():
                file_name = _extract_file_name(cache_key)
                if file_name and file_name not in SCHEMA_CACHE_BY_FILENAME:
